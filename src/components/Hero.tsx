                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-none border border-primary/20 bg-primary/5 text-primary mb-6">
                            ...
                            <span className="font-mono text-xs uppercase tracking-widest">Initialization Complete</span>
                        </div>

                        {/* DÜZELTME 1: Font boyutları mobile göre ayarlandı (text-4xl -> lg:text-8xl) */}
                        ...
                        <div className="grid grid-cols-3 gap-3 lg:gap-4 font-mono">
                            <div className="p-3 lg:p-4 border border-border bg-card">
                                ...
                                <div className="text-[10px] uppercase text-muted mb-1">Architecture</div>
                            ...
                            <div className="p-3 lg:p-4 border border-border bg-card">
                                ...
                                <div className="text-[10px] uppercase text-muted mb-1">Database</div>
                                <div className="text-xs font-bold">SQL / NoSQL</div>
                            </div>
                            <div className="p-3 lg:p-4 border border-border bg-card">
                                <Terminal size={20} className="mb-2 text-accent" />
                                <div className="text-[10px] uppercase text-muted mb-1">Language</div>
                    ...
                    {/* --- SAĞ TARAF (CHAT) --- */}
                    {/* DÜZELTME 2: 'hidden' kaldırıldı, mobilde de görünecek */}
                    <motion.div
