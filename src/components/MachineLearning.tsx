        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="space-y-4 max-w-2xl">
            ...
            <p className="text-slate-400 text-lg">
              Veri bilimi dünyasında kaybolma! Regresyondan Derin Öğrenmeye kadar tüm temel algoritmaları, kullanım alanlarını ve kod mantıklarını inceleyebileceğin interaktif rehber.
            </p>
          </div>
          <Link
            href="/ml"
