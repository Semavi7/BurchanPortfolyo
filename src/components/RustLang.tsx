        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="space-y-4 max-w-2xl">
            ...
            <p className="text-slate-400 text-lg">
              Bellek güvenliğini Garbage Collector olmadan sağlayın. Ownership modeli, Borrow Checker ve güvenli eşzamanlılık (concurrency) konularını interaktif olarak öğrenin.
            </p>
          </div>
          <Link
            href="/rust"
